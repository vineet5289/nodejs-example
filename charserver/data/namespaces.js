const MongoDB = require('../mongo/mongoClientConnection');

// Bring in the room class
const Namespace = require('../classes/Namespace').Namespace;
const CreateNamespace = require('../classes/Namespace').CreateNamespace;
const FetchNamespaces = require('../classes/Namespace').FetchNamespaces;
const Room = require('../classes/Room').Room;
const CreateRoom = require('../classes/Room').CreateRoom;
const FetchRoom = require('../classes/Room').FetchRooms;
